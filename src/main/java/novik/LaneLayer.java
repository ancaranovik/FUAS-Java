...
/**
 * Legacy lane layer class for backward compatibility
 * Lớp lane layer cũ để tương thích ngược
 * 
 * @deprecated Use {@link novik.layer.LaneLayer} instead
 */
@Deprecated
public class LaneLayer {
    ...
    /**
     * Rebuild the lane layer
     * Xây dựng lại lớp lane
     */
    public void rebuild() {
