...
public final class MapUtil {
    ...
    /** Flag indicating if bounds/scale are computed and ready */
     ...
     * @param margin Margin around the map in pixels
     */
     ...
     * 
     * @return List of lane polylines, each polyline is a list of Point2D in screen coordinates
     */
